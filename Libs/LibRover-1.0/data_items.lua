...
data.portkeys = { -- smile if you're a muggle
	...
	{item=182773, destination="Seat of the Primus/0 47.21,30.47", cost=hearthcost, toy=true,function() local c=ZGV.Parser.ConditionEnv return c.covenant()==c.Necrolord end}, -- Necrolord Hearthstone
	{item=184353, destination="Elysian Hold/0 48.44,58.76", cost=hearthcost, toy=true,function() local c=ZGV.Parser.ConditionEnv return c.covenant()==c.Kyrian end}, -- Kyrian Hearthstone
	{item=183716, destination="Sinfall/0 65.94,33.10", cost=hearthcost, toy=true,function() local c=ZGV.Parser.ConditionEnv return c.covenant()==c.Venthyr end}, -- Venthyr Hearthstone
	{item=180290, destination="Heart of the Forest/0 54.94,56.29", cost=hearthcost, toy=true,function() local c=ZGV.Parser.ConditionEnv return c.covenant()==c.NightFae end}, -- Night Fae Hearthstone
