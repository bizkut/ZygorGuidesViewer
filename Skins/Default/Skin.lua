...
function FrameProto:AlignFrame()  -- mixed into Frame, never called on Skin!!
	...
	if upsideup then
		...
		CHAIN(frame.Controls.Scroll)
			:SetPoint("TOPLEFT",ZGV.Frame.Border,"TOPLEFT",SkinData("ViewerMargin"),-10-SkinData("TabsTopOffset"))
			frame.Controls.Scroll:SetPoint("BOTTOMRIGHT",ZGV.Frame.Border.Guides,"TOPRIGHT",0,8-SkinData("TabsTopOffset"))
		CHAIN(frame.Border.Guides)
